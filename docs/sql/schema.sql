...
--         LCR_REPORT_DATA, OSFI_LCR_ADJUSTMENT,
--         LCR_CALCULATED_DATA, LCR_CALCULATED_DEPENDENCY, LCR_REFERENCE_DATA
-- ============================================================


-- ============================================================
-- DROP TABLES (reverse FK order for clean re-creation)
-- ============================================================
DROP TABLE IF EXISTS LCR_REFERENCE_DATA;
DROP TABLE IF EXISTS LCR_CALCULATED_DEPENDENCY;
DROP TABLE IF EXISTS LCR_CALCULATED_DATA;
DROP TABLE IF EXISTS OSFI_LCR_ADJUSTMENT;
DROP TABLE IF EXISTS LCR_REPORT_DATA;
DROP TABLE IF EXISTS LCR_REPORT_LINE_LEVEL;
DROP TABLE IF EXISTS COMMENT;
DROP TABLE IF EXISTS LCR_SEGMENT;
DROP TABLE IF EXISTS LCR_REPORT_LINE;
...
-- ===================== OSFI_LCR_ADJUSTMENT (user adjustments) =====================
